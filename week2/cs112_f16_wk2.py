_module = 'cs112_f16_wk2.py version 1.0'
# Place this file in the same folder as your week2 Python files.
# While you need to use this file to do your week2 exercises, students
